...
export const errors = {
  ...
  INVITATION_NOT_FOUND: { code: 30012, message: '邀请不存在', status: StatusCodes.NOT_FOUND },
  INVITATION_EXPIRED: { code: 30013, message: '邀请已过期', status: StatusCodes.GONE },
  INVITATION_ALREADY_ACCEPTED: { code: 30014, message: '邀请已被接受', status: StatusCodes.CONFLICT },
  INVITATION_CANCELLED: { code: 30015, message: '邀请已被取消', status: StatusCodes.GONE },
